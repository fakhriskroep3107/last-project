...
if (!empty($_SESSION['id']) && !empty($_SESSION['email'])) {
  ...
  if ($pengembalian = $statement->fetch()) {
    $id = $pengembalian['id'];
    $anggotaId = $pengembalian['anggota_id'];
    $anggota = $pengembalian['anggota'];
    $bookId = $pengembalian['book_id'];
    $buku = $pengembalian['buku'];
    $tglPinjam = $pengembalian['tgl_pinjam'];
